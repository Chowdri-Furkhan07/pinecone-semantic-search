...
| Upload & Index | Natural Language Query | Search Results |
|:---:|:---:|:---:|
| ![Upload screenshot](screenshots/Upload_File.png) | ![Query screenshot](screenshots/Preview.png) | ![Results screenshot](screenshots/Retrieval.png) |
